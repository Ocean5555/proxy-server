...
public class DataTransHandler {
    ...
    public static void bindClientAndTarget(Socket clientSocket, Socket targetSocket)throws Exception{
        createClientThread(clientSocket, targetSocket);
        createTargetThread(clientSocket, targetSocket);
    }
    ...
    public static void createTargetThread(Socket clientSocket, Socket targetSocket) throws IOException {
